...
public class PdfService {
    ...
    public void init() {
        ...
        InputStream stream = this.getClass().getResourceAsStream("/templates/table-test.mustache");
        InputStreamReader streamReader = new InputStreamReader(stream);
        this.tableTest = mf.compile(streamReader, "chart");
    }
    ...
    public byte[] getTestPdf() throws IOException {
